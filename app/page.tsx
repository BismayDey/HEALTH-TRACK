  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f8fafc]">
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              size="sm"
              className="hidden md:flex text-[#0284c7] border-[#0284c7]"
            >
              <Phone className="mr-2 h-4 w-4" />
              <span className="font-semibold">1-800-HEALTH</span>
            </Button>
            <Button
              size="sm"
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-40 bg-gradient-to-r from-[#f0f9ff] to-[#e0f2fe]">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button
                    size="lg"
                    className="bg-[#0284c7] hover:bg-[#0369a1] text-white inline-flex items-center gap-2 shadow-sm"
                  >
                    Book an Appointment
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm mt-4">
                  <div className="flex items-center gap-1 bg-white rounded-full px-3 py-1 shadow-sm">
                    ...
                    <span className="text-[#334155]">24/7 Emergency Care</span>
                  </div>
                  <div className="flex items-center gap-1 bg-white rounded-full px-3 py-1 shadow-sm">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="group overflow-hidden transition-all hover:shadow-md border-none bg-white">
                ...
                <CardContent className="px-6 pb-6">
                  <CardDescription className="text-base text-[#64748b]">
                    Early detection of skin diseases, diabetes risk factors, and
                    heart conditions through our advanced AI diagnostic tools.
                    Upload images or input symptoms for analysis.
                  </CardDescription>
                </CardContent>
                <div className="px-6 pb-6">
              ...
              <Card className="group overflow-hidden transition-all hover:shadow-md border-none bg-white">
                ...
                <CardContent className="px-6 pb-6">
                  <CardDescription className="text-base text-[#64748b]">
                    ...
                    first aid, and community support during emergencies. One-tap
                    emergency contact.
                  </CardDescription>
                </CardContent>
                <div className="px-6 pb-6">
                ...
                <div className="px-6 pb-6">
                  <div className="bg-[#f8fafc] rounded-lg p-4 mb-4">
                    <div className="space-y-3">
                      <div className="bg-white p-2 rounded border border-[#e2e8f0]">
                        <div className="text-xs text-[#64748b]">Nutrition</div>
