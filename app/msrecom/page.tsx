...
// Mood options for the recommendation system
const moodOptions = [
  "Depressed",
  "Sad",
  "Lonely",
...
export default function RecommendationsPage() {
  ...
  const handleGetRecommendations = async () => {
    ...
    try {
      ...
      // Add completed property to each song and movie
      ...
      // Update the recommendation with the document ID and timestamp
  ...
  // Toggle completion status of a song or movie
  const toggleCompletion = async (type: "song" | "movie", index: number) => {
    ...
    try {
      ...
      // Show feedback form if all completed
  ...
  // If not authenticated, redirect to auth page (handled in useEffect)
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        0 = Poor mental health, 5 = Excellent mental health
                      </p>
                    </div>
